...
@Entity
@Table(name = "customer", schema = "schedular1", catalog = "")
public class CustomerEntity {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, createdDate, firstName, lastName, unitNo, street, suburb, state, postalCode, country, phone, email, deleteStatus, birthday, maritalStatus, gender, nic);
    }
}
