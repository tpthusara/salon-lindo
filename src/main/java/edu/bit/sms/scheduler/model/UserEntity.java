...
@Entity
@Table(name = "user", schema = "schedular1", catalog = "")
public class UserEntity {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, createDate, userName, password, userType, verificationStatus, passwordChangedDate, deleteStatus, employeeId);
    }
}
